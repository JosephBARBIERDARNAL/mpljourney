...
```
root/
├── mpljourney/             - Main package directory
│   ├── __init__.py
│   └── main.py/
├── tests/                    - Unit tests
│   ├── __init__.py
...
```bash
git clone https://github.com/JosephBARBIERDARNAL/mpljourney.git
```

### Replace with your package info

- Replace **all** `JosephBARBIERDARNAL` with your GitHub username or organization
- Replace **all** `mpljourney` with your actual package
...
```python
from mpljourney import add_digit
